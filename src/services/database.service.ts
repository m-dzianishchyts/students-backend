...
let resolveInitialization: (value: void) => void;
const initializedDatabase = new Promise<void>((resolve, error) => {
...
const gridFsStorage = new GridFsStorage({
    ...
    file: (request, file) => {
        return {
            ...
            contentType: mimeLookup(file.originalname),
...
export const connection = mongodb.connection;
export const gridFs = { bucket: gridFsBucket, storage: gridFsStorage };
export { initializedDatabase, MongoErrorCode };
